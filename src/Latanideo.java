...
public class Latanideo {
    ...
    void mostrarCarta() {
        ...
        for (String nomeCarta : cardList) {
            Image imagemCarta = new ImageIcon(getClass().getResource("./latanideo/" + nomeCarta + ".jpg")).getImage();
        ...
        Image imagemTrasCarta = new ImageIcon(getClass().getResource("./latanideo/tras.jpg")).getImage();
