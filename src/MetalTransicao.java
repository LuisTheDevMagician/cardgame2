...
public class MetalTransicao {
    ...
    String[] cardList = {
            "bohrio", "cadmio", "cobalto",
            "cobre", "cromo", "dubnio",
            "escandio", "ferro", "hafnio",
            "hassio", "iridio", "itrio",
            "manganes", "mercurio", "molibdenio",
            "niobio", "niquel", "osmio",
            "ouro", "paladio", "platina",
            "prata", "renio", "rodio",
            "rutenio", "ruterfordio", "seaborgio",
            "tantalo", "tecnecio", "titanio",
            "tungstenio", "vanadio", "zinco", "zirconio"
    };
    ...
    MetalTransicao() {
        ...
        frame.setBounds(0, 50, bordaLargura, bordaAltura );
        ...
        esconderCartas = new Timer(10000, new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    void mostrarCarta() {
        ...
        for (String nomeCarta : cardList) {
            Image imagemCarta = new ImageIcon(getClass().getResource("./metaltransicao/" + nomeCarta + ".jpg")).getImage();
        ...
        Image imagemTrasCarta = new ImageIcon(getClass().getResource("./metaltransicao/tras.jpg")).getImage();
