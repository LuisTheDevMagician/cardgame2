...
public class SuperPesado {
    ...
    void mostrarCarta() {
        ...
        for (String nomeCarta : cardList) {
            Image imagemCarta = new ImageIcon(getClass().getResource("./superpesado/" + nomeCarta + ".jpg")).getImage();
        ...
        Image imagemTrasCarta = new ImageIcon(getClass().getResource("./superpesado/tras.jpg")).getImage();
