...
public class NaoMetal {
    ...
    void mostrarCarta() {
        ...
        for (String nomeCarta : cardList) {
            Image imagemCarta = new ImageIcon(getClass().getResource("./naometal/" + nomeCarta + ".jpg")).getImage();
        ...
        Image imagemTrasCarta = new ImageIcon(getClass().getResource("./naometal/tras.jpg")).getImage();
