...
public class MetalPosTransicao {
    class Carta {
        String nomeCarta;
    ...
    void mostrarCarta() {
        ...
        for (String nomeCarta : cardList) {
            Image imagemCarta = new ImageIcon(getClass().getResource("./metalpostransicao/" + nomeCarta + ".jpg")).getImage();
        ...
        Image imagemTrasCarta = new ImageIcon(getClass().getResource("./metalpostransicao/tras.jpg")).getImage();
